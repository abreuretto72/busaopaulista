...
public class MapaGeralOkActivity extends FragmentActivity  implements   PesqParadaSPTransListener, PegaDadosSearchByListener
{
  ...
  SupportMapFragment mapFragment;
   ...
   // PegaPontoTask     pontotask;
	...
	
	{
		...
		try
		{	
		setContentView(R.layout.activity_mapa_geral_ok);	
		}
		catch (Exception e)
        {
			Toast.makeText(this, "Problema com acesso ao mapa do Google!", Toast.LENGTH_LONG).show();
			finish();
        }
		...
		if (!cd.isConnectingToInternet())
		   {
	           ...
	           builder.setTitle(this.getResources().getString(R.string.interneterrorpede))
	               ...
	               .setPositiveButton("Ok", new DialogInterface.OnClickListener() 
	               {
	                   ...
	                   {
	                	   MapaGeralOkActivity.this.finish();
	                	   return;
	                   }
	               });
	             builder.create().show();  
        ...
        googleMap.setOnInfoWindowClickListener(
                        new OnInfoWindowClickListener(){
                            public void onInfoWindowClick(Marker marker) {
		        		    	...
		        		    	Intent nextScreen = new Intent(MapaGeralOkActivity.this, MostraLinhaActivity.class);
               ...
               if (parada > 0) 
               {
            	    ...
            	    String ende = endex.replace("Null", "");
            	  	...
            	  	if (eventInfo.getTipo() < 3)
		               ...
		               geocoder = new Geocoder(MapaGeralOkActivity.this, Locale.getDefault());
		 ...
		 public void PegaPreferences()
		   {
			   ...
			   String valor = appPrefs.getString("listapontos", "OK");
			   ...
			   if (valor.indexOf("OK") < 0 )
			   {
				   
			   temponto = true;
			   GsonBuilder gsonb = new GsonBuilder();
			   Gson gson = gsonb.create();
			   EventInfo[] listaP = gson.fromJson(valor, EventInfo[].class);
			   listaponto.clear();
	...
	*/
			...
			*/
			...
			public void Blinha(View v)
			{
				...
				Intent nextScreen = new Intent(MapaGeralOkActivity.this, MostraSearchLinhasActivity.class);
